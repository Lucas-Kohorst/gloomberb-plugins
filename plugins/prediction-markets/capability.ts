import { chartSeriesProvider, type ChartSeriesCatalogItem, type ChartSeriesResolveRequest } from "gloomberb/capabilities";
import { debugLog } from "gloomberb/utils";
import type { ResolvedSeries, TimeSeriesPoint } from "gloomberb/capabilities";
import {
  loadKalshiCatalog,
  loadKalshiHistory,
