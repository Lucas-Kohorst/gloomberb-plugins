import type { ChartSeriesCatalogItem, ChartSeriesResolveRequest } from "gloomberb/capabilities";
...
interface TimeSeriesPoint {
  ...
  close?: number | null;
  volume?: number | null;
  provenance?: { providerId?: string; quality?: "reported" | "derived" | "estimated" };
}
...
interface ResolvedSeries {
  ...
  unit: string;
  unitGroup: string;
  nativeFrequency: "auto" | "daily" | "weekly" | "monthly" | "quarterly" | "annual" | "ttm";
  dataShape: "scalar" | "ohlcv" | "event" | "band";
  style: "line" | "area" | "step" | "columns" | "points" | "candles" | "ohlc" | "hlc";
  transform: "raw" | "percent" | "index100" | "yoy" | "qoq" | "log";
  axis: "left" | "right";
  panelId: string;
  interpolation: "none" | "step-after";
...
export function predictionHistoryPoints(
...
async function catalog(query = "", limit = 8, signal?: AbortSignal): Promise<ChartSeriesCatalogItem[]> {
  const providers = [
